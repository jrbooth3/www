...
$prevmileage = "0";
include 'opendb.php';
$result = mysqli_query($conprd, "SELECT model, mileage, date, gallons FROM rawdata, vehicle WHERE vehicle.vehicleid = rawdata.vehicle AND vehicle.vehicleid = '$vehicle' ORDER by date desc limit 5");
