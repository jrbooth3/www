...
$staticquery = "INSERT INTO staticint (staticitem, staticmileage, statowner) VALUES('$staticitem','$staticmileage', '$userid' )";
echo "$staticitem $staticmileage $userid $vehicleid";
