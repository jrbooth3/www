...
echo "IP address Lethe001/X2=192.168.86.4<br>";
echo "IP address Styx0001/X0=192.168.86.3<br>";
echo "IP address Styx0001/X1=dynamic router<br>";
echo "IP address /X1=dynamic router<br>";
echo "IP address Styx0001/X1=dynamic router<br>";
...
echo "router > switch1/vlan1 > Lethe001/X1 > Lethe001/X0 > switch1/vlan0<br>";
echo "Lethe001/X2 > switch1/vlan0<br>";
echo "router > switch2/vlan1 > Styx0001/X1 > Styx0001/X0 > switch2/vlan0<br>";
echo "router > Styx0001 > switch2 (vlan1)<br>";
