...
$sqlh4 = "SELECT resptime FROM status where date >= (NOW() - INTERVAL '120 minute') and name = 'K12';";
$sqlh3 = "SELECT resptime FROM status where date >= (NOW() - INTERVAL '120 minute') and name = 'Google';";
