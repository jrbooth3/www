...
$sqlh4 = "SELECT cputemp FROM nwstatus.handbrake where svrnm = 'artemis' and timestamp >= DATE_SUB(NOW(), INTERVAL 1 hour);";
$sqlh3 = "SELECT cputemp FROM nwstatus.handbrake where svrnm = 'apollo'  and timestamp >= DATE_SUB(NOW(), INTERVAL 1 hour);";
