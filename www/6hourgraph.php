...
$sqlh4 = "SELECT cputemp FROM nwstatus.handbrake where svrnm = 'artemis' and timestamp >= DATE_SUB(NOW(), INTERVAL 6 hour);";
$sqlh3 = "SELECT cputemp FROM nwstatus.handbrake where svrnm = 'apollo'  and timestamp >= DATE_SUB(NOW(), INTERVAL 6 hour);";
