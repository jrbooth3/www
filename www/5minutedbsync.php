...
$sqlh4 = "SELECT time from db_rep WHERE prc = 'restore' and date > ( NOW() - INTERVAL '5 minute') and server = 'venus' order by date;";
$sqlh3 = "SELECT time from db_rep WHERE prc = 'restore' and date > ( NOW() - INTERVAL '5 minute') and server = 'Saturn' order by date;";
$sqlh2 = "SELECT time from db_rep WHERE prc = 'restore' and date > ( NOW() - INTERVAL '5 minute') and server = 'jupiter' order by date;";
$sqlh1 = "SELECT time from db_rep WHERE prc = 'backup' and date > ( NOW() - INTERVAL '5 minute') and server = 'neptune' order by date;";
