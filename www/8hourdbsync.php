...
$sqlh4 = "SELECT time from db_rep WHERE date > ( NOW() - INTERVAL '8 hour') and server = 'venus' order by date;";
$sqlh3 = "SELECT time from db_rep WHERE date > ( NOW() - INTERVAL '8 hour') and server = 'Saturn' order by date;";
$sqlh2 = "SELECT time from db_rep WHERE date > ( NOW() - INTERVAL '8 hour') and server = 'jupiter' order by date;";
//$sqlh1 = "SELECT time from db_rep WHERE date > ( NOW() - INTERVAL '8 hour') and server = 'neptune' order by date;";
